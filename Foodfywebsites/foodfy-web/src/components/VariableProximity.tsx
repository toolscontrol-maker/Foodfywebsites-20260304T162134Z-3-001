import React, { forwardRef, useMemo, useRef, useEffect, ForwardRefExoticComponent, RefAttributes } from 'react';
          ...
          {word.split('').map(letter => {
            ...
            return (
              <motion.span
                ...
                ref={el => {
                  letterRefs.current[currentLetterIndex] = el as HTMLElement;
                }}
                style={{
